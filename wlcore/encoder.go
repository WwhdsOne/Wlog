...
func Encoder(encodeLevel string, isJson, adaptRfc5424 bool) zapcore.Encoder {
	...
	if !adaptRfc5424 {
		config.EncodeTime = func(t time.Time, encoder zapcore.PrimitiveArrayEncoder) { // 时间编码器
